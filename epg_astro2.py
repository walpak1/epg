...
def fetch_schedule_pages(
    authorization: str, start_utc: datetime, end_utc: datetime
) -> list[dict]:
    headers = {
        "Authorization": authorization,
    ...
    while cursor < end_utc:
        ...
        params = {
            ...
            "limit": str(SCHEDULE_PAGE_LIMIT),
            "genreId": "",
            "isPlayable": "false",
            "duration": str(window_hours),
            "clientToken": "v:1!r:80300!ur:SABAH!community:Malaysia Live!t:k!dt:STB!f:Astro_unmanaged!pd:STB-FF!pt:Adults",
        }
...
def main() -> None:
    ...
    schedule_payload = fetch_schedule_pages(authorization, start_utc, end_utc)
